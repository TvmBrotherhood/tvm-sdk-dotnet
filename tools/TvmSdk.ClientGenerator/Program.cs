    ...
    .ToDictionary(
        ...
        x =>
        {
            ...
            return (
                ...
                Filepath: $"{projectPath}/{string.Join('/', @namespace)}/{x.Type.Name}.cs"
            );
        });
...
void GenerateModuleInterface(ApiModule module)
{
    ...
    Syntax.Declaration
        ...
        .WriteTo($"{projectPath}/{projectName}/Modules/{module.Name.ToPascalCase()}/I{moduleName}.cs");
}
...
void GenerateModuleClass(ApiModule module, string clientInterfaceName)
{
    ...
    Syntax.Declaration
        ...
        .ToFileScopedNamespace($"{projectName}.Modules.{module.Name.ToPascalCase()}")
        .ToCompilationUnit()
        .WriteTo($"{projectPath}/{projectName}/Modules/{module.Name.ToPascalCase()}/{moduleName}.cs");
}