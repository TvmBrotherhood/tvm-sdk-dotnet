...
/// </summary>
public class DebotModule(ITvmClient client) : IDebotModule
{
    /// <remarks>
    ...
    {
        return client.CallFunction<RegisteredDebot>("debot.init", @params);
    }
    ...
    {
        return client.CallFunction("debot.start", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfFetch>("debot.fetch", @params);
    }
    ...
    {
        return client.CallFunction("debot.execute", @params);
    }
    ...
    {
        return client.CallFunction("debot.send", @params);
    }
    ...
    {
        return client.CallFunction("debot.remove", @params);
    }
}