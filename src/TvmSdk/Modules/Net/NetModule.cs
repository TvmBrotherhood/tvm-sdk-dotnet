...
/// Network access.
/// </summary>
public class NetModule(ITvmClient client) : INetModule
{
    /// <summary>
    ...
    {
        return client.CallFunction<ResultOfQuery>("net.query", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfBatchQuery>("net.batch_query", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfQueryCollection>("net.query_collection", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfAggregateCollection>("net.aggregate_collection", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfWaitForCollection>("net.wait_for_collection", @params);
    }
    ...
    {
        return client.CallFunction("net.unsubscribe", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfSubscribeCollection>("net.subscribe_collection", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfSubscribeCollection>("net.subscribe", @params);
    }
    ...
    public Task Suspend()
    {
        return client.CallFunction("net.suspend");
    }
    ...
    public Task Resume()
    {
        return client.CallFunction("net.resume");
    }
    ...
    {
        return client.CallFunction<ResultOfFindLastShardBlock>("net.find_last_shard_block", @params);
    }
    ...
    {
        return client.CallFunction<EndpointsSet>("net.fetch_endpoints");
    }
    ...
    {
        return client.CallFunction("net.set_endpoints", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfGetEndpoints>("net.get_endpoints");
    }
    ...
    {
        return client.CallFunction<ResultOfQueryCollection>("net.query_counterparties", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfQueryTransactionTree>("net.query_transaction_tree", @params);
    }
    ...
    {
        return client.CallFunction<RegisteredIterator>("net.create_block_iterator", @params);
    }
    ...
    {
        return client.CallFunction<RegisteredIterator>("net.resume_block_iterator", @params);
    }
    ...
    {
        return client.CallFunction<RegisteredIterator>("net.create_transaction_iterator", @params);
    }
    ...
    {
        return client.CallFunction<RegisteredIterator>("net.resume_transaction_iterator", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfIteratorNext>("net.iterator_next", @params);
    }
    ...
    {
        return client.CallFunction("net.remove_iterator", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfGetSignatureId>("net.get_signature_id");
    }
}