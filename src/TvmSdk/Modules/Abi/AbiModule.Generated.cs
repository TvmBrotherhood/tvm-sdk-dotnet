...
/// </summary>
public class AbiModule(ITvmClient client) : IAbiModule
{
    /// <summary>
    ...
    {
        return client.CallFunction<ResultOfEncodeMessageBody>("abi.encode_message_body", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfAttachSignatureToMessageBody>("abi.attach_signature_to_message_body", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfEncodeMessage>("abi.encode_message", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfEncodeInternalMessage>("abi.encode_internal_message", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfAttachSignature>("abi.attach_signature", @params);
    }
    ...
    {
        return client.CallFunction<DecodedMessageBody>("abi.decode_message", @params);
    }
    ...
    {
        return client.CallFunction<DecodedMessageBody>("abi.decode_message_body", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfEncodeAccount>("abi.encode_account", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfDecodeAccountData>("abi.decode_account_data", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfUpdateInitialData>("abi.update_initial_data", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfEncodeInitialData>("abi.encode_initial_data", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfDecodeInitialData>("abi.decode_initial_data", @params);
    }

    /// <remarks>
    /// Solidity functions use ABI types for <a href="https://github.com/everx-labs/TON-Solidity-Compiler/blob/master/API.md#tvmbuilderstore">builder encoding</a>.<para/>
    ...
    {
        return client.CallFunction<ResultOfDecodeBoc>("abi.decode_boc", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfAbiEncodeBoc>("abi.encode_boc", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfCalcFunctionId>("abi.calc_function_id", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfGetSignatureData>("abi.get_signature_data", @params);
    }
}