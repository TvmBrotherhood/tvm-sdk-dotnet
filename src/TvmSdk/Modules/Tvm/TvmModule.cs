...
public class TvmModule(ITvmClient client) : ITvmModule
{
    /// <remarks>
    ...
    {
        return client.CallFunction<ResultOfRunExecutor>("tvm.run_executor", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfRunTvm>("tvm.run_tvm", @params);
    }
    ...
    {
        return client.CallFunction<ResultOfRunGet>("tvm.run_get", @params);
    }
}