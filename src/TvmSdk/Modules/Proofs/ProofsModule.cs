...
/// </summary>
public class ProofsModule(ITvmClient client) : IProofsModule
{
    /// <remarks>
    ...
    {
        return client.CallFunction("proofs.proof_block_data", @params);
    }
    ...
    {
        return client.CallFunction("proofs.proof_transaction_data", @params);
    }
    ...
    {
        return client.CallFunction("proofs.proof_message_data", @params);
    }
}