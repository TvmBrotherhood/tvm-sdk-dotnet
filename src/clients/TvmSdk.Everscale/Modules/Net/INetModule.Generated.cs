...
public interface INetModule
{
    ...
    /// </remarks>
    Task<ResultOfSubscribeCollection> SubscribeCollection(ParamsOfSubscribeCollection @params);
    ...
    /// </remarks>
    Task<ResultOfSubscribeCollection> Subscribe(ParamsOfSubscribe @params);
    ...
    /// </summary>
    Task<ResultOfFindLastShardBlock> FindLastShardBlock(ParamsOfFindLastShardBlock @params);

    /// <summary>
    /// Requests the list of alternative endpoints from server.
    /// </summary>
    Task<EndpointsSet> FetchEndpoints();

    /// <summary>
    /// Sets the list of endpoints to use on reinit.
    /// </summary>
    Task SetEndpoints(EndpointsSet @params);
    ...
    /// </summary>
    Task<ResultOfGetSignatureId> GetSignatureId();
}