...
/// </summary>
public class ProofsModule(ITvmSdkDllAdapter adapter) : IProofsModule
{
    /// <remarks>
    ...
    {
        return adapter.CallMethod("proofs.proof_block_data", @params);
    }
    ...
    {
        return adapter.CallMethod("proofs.proof_transaction_data", @params);
    }
    ...
    {
        return adapter.CallMethod("proofs.proof_message_data", @params);
    }
}