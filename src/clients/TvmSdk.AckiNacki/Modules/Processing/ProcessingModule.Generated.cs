...
/// </remarks>
public class ProcessingModule(ITvmSdkDllAdapter adapter) : IProcessingModule
{
    /// <remarks>
    ...
    {
        return adapter.CallMethod("processing.monitor_messages", @params);
    }
    ...
    {
        return adapter.CallMethod<ParamsOfGetMonitorInfo, MonitoringQueueInfo>("processing.get_monitor_info", @params);
    }
    ...
    {
        return adapter.CallMethod<ParamsOfFetchNextMonitorResults, ResultOfFetchNextMonitorResults>("processing.fetch_next_monitor_results", @params);
    }
    ...
    {
        return adapter.CallMethod("processing.cancel_monitor", @params);
    }
    ...
    {
        return adapter.CallMethod<ParamsOfSendMessages, ResultOfSendMessages>("processing.send_messages", @params);
    }
    ...
    {
        return adapter.CallMethod<ParamsOfSendMessage, ResultOfSendMessage>("processing.send_message", @params);
    }
    ...
    {
        return adapter.CallMethod<ParamsOfWaitForTransaction, ResultOfProcessMessage>("processing.wait_for_transaction", @params);
    }
    ...
    {
        return adapter.CallMethod<ParamsOfProcessMessage, ResultOfProcessMessage>("processing.process_message", @params);
    }
}